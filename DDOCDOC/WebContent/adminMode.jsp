...
<!-- 
	origin:
    <button><a href="/DDOCDOC/hospital/hospitalList.do?customer=${customer }">병원관리</a></button>
	<button><a href="/DDOCDOC/pharmacy/pharmacyList.do">약국관리</a></button>
 -->
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
	                      <a href="/DDOCDOC/hospital/hospitalList.do?customer=${customer }" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm tobtnfromicon">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
	                      <a href="/DDOCDOC/pharmacy/pharmacyList.do" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm tobtnfromicon">
          ...
          <div class="row">
            ...
            <div class="col-xl-12">
              <div class="card shadow mb-4">
                ...
                <!-- Card Body -->
                <div class="card-body">
                  <div class="chart-area" style="height:28rem;">
                  	<img src="../img/front_hos.jpg" alt="front" style="width: 100%;height: 100%;">
                  </div>
                </div>
              </div>
            </div>
