    ...
    <body>
       ...
       MENU: Header Section Start
                    ...
                    <div class="col-md-12">
                        <div class="block">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">DETAIL REVIEW</li>
                            </ol>
                        </div>
                    </div>
                </div>
		...
		<section class="company-description" id="wrapjoin" style="display: flex; justify-content: center;">
			...
			<form action="reviewUpdateForm.do?seq=${reviewvo.rv_num }" method="post" >
				<input type = "submit" value="수정" class="btn btn-warning">
			</form>&nbsp&nbsp&nbsp
			<form action="reviewDelete.do?seq=${reviewvo.rv_num }" method="post">
