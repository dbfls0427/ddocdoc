...
<html class="no-js">
	...
	<div class="container">
		...
		<c:forEach var="reviewvo" items="${list }">
			<tr>
				<td style="text-align : center;">${reviewvo.rv_num }</td>
				<td style="text-align : center;"><a href="reviewDetail.do?seq=${reviewvo.rv_num }">${reviewvo.rv_title }</a></td>
				<td style="text-align : center;">${cus_name }</td>
				<td style="text-align : center;">${reviewvo.rv_date }</td>
				<td style="text-align : center;">${reviewvo.rv_count }</td>
