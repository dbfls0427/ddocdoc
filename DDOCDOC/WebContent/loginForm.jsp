				...
				<div class="panel-body">
					<form action="login.do" method = "post">
						<div class="form-group">
							<label>ID</label>
							<input type = "text" name = "customerID" class="form-control input-lg" placeholder="ID">
						</div>
						<div class="form-group">
							<label>Password</label>
							<input type = "text" name = "customerPW" class="form-control input-lg" placeholder="Password">
						</div>
