...
<body>
	...
	<section id="forming"  class="company-description" style="display: flex; justify-content: center; margin-bottom: 50px;">
		<label>${inj_info_name }</label><br>
		<label>접종시기</label>&nbsp<span>${inj_info_date }</span><br>
		<form action="InsertInjAction.do" method="post">
			...
			<div>
			접종일 : <input type="text" name="inj_date" id="datepicker" class="form-control" style="width: 300px; font-size: 20px;">
			</div>
			<script>
			...
			<br>
			메모 : <input type="text" name="inj_memo" class="form-control"><br>
