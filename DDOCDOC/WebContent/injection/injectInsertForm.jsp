...
<body>
	...
	<section id="forming"  class="company-description" style="display: flex; justify-content: center; margin-bottom: 50px;">
	  <div style="display: flex; justify-content: center;">
	  		<div>
				<label style="font-size: 30px; color: #2c4ab5;">${inj_info_name }</label><br>
				
				<div style="display: flex; justify-content: center; margin-bottom: 20px; margin-top: 10px;">
					<label id="fsize2">접종시기</label>&nbsp&nbsp<label id="fsize2" style="color: #dc4040;">${inj_info_date }</label><br>
				</div>
				<form action="InsertInjAction.do" method="post">
					...
					<div style="display: flex; justify-content: center">
						<label id="fsize" style="margin-right: 10px;">접종일</label><br>
						<input type="text" name="inj_date" id="datepicker" class="form-control" style="width: 150px; font-size: 20px;margin-right: 0; width: 280px;">
					</div>
						<script>
						...
						<div style="margin-top: 10px;">
							<label id="fsize">메모</label>&nbsp&nbsp<input type="text" name="inj_memo" class="form-control"><br>
						</div>
						<div style="display: flex;justify-content: center;">
