        	...
        	<div id="joinformdiv">
	        	<form action="joinAction.do" method = "post">
	        		<div class="form-group">
						<label>ID</label>
						<input type = "text" name = "joinID" class="form-control input-lg" placeholder="ID">
					</div>
					<div class="form-group">
						<label>PW</label>
						<input type = "text" name = "joinPW" class="form-control input-lg" placeholder="Passward">
					</div>
					<div class="form-group">
						<label>이름</label>
						<input type = "text" name = "joinName" class="form-control input-lg" placeholder="이름">
					</div>
					<div class="form-group">
						<label>주소</label>
						<input type = "text" name = "joinAddr" class="form-control input-lg" placeholder="주소">
					</div>
					<div class="form-group">
						<label>이메일</label>
						<input type = "text" name = "joinEmail" class="form-control input-lg" placeholder="이메일">
					</div>
					<div class="form-group">
						<label>생년월일</label>
